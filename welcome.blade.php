...
<html lang="en">
    ...
    <div class="absolute flex items-right flex-col text-center font-semibold pl-4 pt-4 text-10 2xl:text-24 2xl:pl-12 2xl:pt-10
    xl:text-20 xl:pl-12 xl:pt-10 md:text-16 md:pl-12 md:pt-10">
    ...
    <div class="flex justify-end 2xl:pt-20 xl:pt-20 md:pt-16">
            <img class="w-12 absolute 2xl:w-48 xl:w-48 md:w-28" src="/images/Vector-3.svg">
        </div>
       ...
       <p class="text-10 pt-10 pb-3 text-darkBlue 2xl:text-14 2xl:pt-0 xl:text-14 xl:pt-0 md:text-14 md:pt-0">
        ...
        <div class="allBoxes flex flex-col text-black 2xl:font-semibold 2xl:flex-nowrap 2xl:flex-row 2xl:gap-x-10 2xl:pt-10 text-12 2xl:text-14
        ...
        md:flex-col-reverse md:items-center md:justify-center">
           ...
           <button class="border-lightBlue border-2 rounded-full px-5 py-2 text-lightBlue font-semibold text-14 mt-4 2xl:mt-16 md:mt-14" id="oneMoreTime">En runda till</button>
        </div>
...
<body class="font-poppins bg-lightBlue">
    ...
    <div class="container h-screen">
        ...
        <div class="flex items-center flex-col text-center justify-center h-full pt-10 xl:pt-20 md:pt-20">
            ...
            <button class="border-white border-2 rounded-full px-5 py-2 text-white font-semibold mt-6 mb-10 text-12" id="yesButton">Ja</button>
            <button class="border-white border-2 rounded-full px-5 py-2 text-white font-semibold mt-6 mb-10 text-12" id="noButton">Nej</button>
            </div>
...
<body class="font-poppins">
    ...
    <script type="text/jav" src="../../storage/questions.json"></script>
